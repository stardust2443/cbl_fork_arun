...
c        local (automatic) variables
      ...
      real*16 ri,phi,zi,ci,si,ph,dph
c *
...
c        upper latitude term
      ...
      ph=0._16
      dph=-tiny
      if (thmin.eq.0._16.or.thmin.eq.PI) then
        si=0._16
        lmx1=1
      else
        si=sin(thmin)
...
c        lower latitude term
      dph=tiny
      if (thmax.eq.0._16.or.thmax.eq.PI) then
        si=0._16
        lmx1=1
      else
        si=sin(thmax)
