...
/**
 *  @file Headers/w0wanuCDM.h
 *
 *  @brief The class w0wanuCDM 
 *
 *  This file defines the interface of the class w0wanuCDM, used for
 *  cosmological calculations in the flat w0-wa-cold dark matter model
...
#ifndef __w0wanuCDM__
#define __w0wanuCDM__
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class w0wanuCDM w0wanuCDM.h "Headers/w0wanuCDM.h"
     *
     *  @brief The class w0wanuCDM
     *
     *  This class is used to handle objects of type <EM> w0wanuCDM
     *  </EM>. They are used for cosmological calculations in the flat
     *  w0-wa-cold dark matter model with massive neutrinos
     */
    class w0wanuCDM : public virtual w0waCDM, public virtual LnuCDM {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class w0wanuCDM
       */
      w0wanuCDM ()
	: w0waCDM(), LnuCDM() { m_model = "w0wanuCDM"; }

      /**
       *  @brief Main Constructor of the class w0wanuCDM
       *
       ...
       *  e.g. Mpc/h)
       */
      w0wanuCDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const double w0, const double wa, const double Omega_neutrinos, const double massless_neutrinos, const int massive_neutrinos, const bool unit=true);

      /**
       *  @brief Constructor of the class w0wanuCDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      w0wanuCDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~w0wanuCDM () = default;
      ...
      { return std::make_shared<w0wanuCDM>(*this); }
      ...
      { return {"Omega_matter", "Omega_CDM", "Omega_baryon", "Omega_radiation", "little_h", "scalar_amp", "scalar_pivot", "sigma8", "n_spec", "tau", "w0", "wa", "Omega_neutrinos", "massless_neutrinos", "massive_neutrinos"}; }
       ...
       *  (1-\Omega_m-\Omega_r)f_{\rm DE}(z) + \Omega_r(1+z)^4} \f]
       *
       ...
       *  \f$f(z)\f$
       *
       *  this function solve the following differential equation:
       *
       * \f[ \dot{f}(z)-\frac{f^2(z)}{1+z} -  \Bigl[\frac{2}{1+z} - \frac{\dot{H}(z)}{H(z)}  \Bigr]f(z) + \frac{3}{2}\frac{\Omega_m(z)}{(1+z)} =0 \ \ \f]
       *
       *  @param redshift the redshift
       *
