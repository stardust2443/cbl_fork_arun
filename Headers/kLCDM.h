...
/**
 *  @file Headers/kLCDM.h
 *
 *  @brief The class kLCDM 
 *
 *  This file defines the interface of the class kLCDM, used for
 *  cosmological calculations in the non-flat Lambda-cold dark matter
 *  model
 *
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class kLCDM kLCDM.h "Headers/kLCDM.h"
     *
     *  @brief The class kLCDM
     *
     *  This class is used to handle objects of type <EM> kLCDM
     *  </EM>. They are used for cosmological calculations in the non-flat
     *  Lambda-cold dark matter model
     */
    class kLCDM : public virtual LCDM {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class kLCDM
       */
      kLCDM ()
	: LCDM() { m_model = "kLCDM"; }

      /**
       *  @brief Main Constructor of the class kLCDM
       *
       ...
       *  at z=0
       *
       *  @param Omega_radiation \f$\Omega_{\rm rad}\f$: the density
       *  of radiation at z=0
       *
       ...
       *  e.g. Mpc/h)
       */
      kLCDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const double Omega_DE, const bool unit=true);

      /**
       *  @brief Constructor of the class kLCDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      kLCDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~kLCDM () = default;
      ...
      { return std::make_shared<kLCDM>(*this); }
       ...
       *  Eq. 6):
       *
       *  \f[ \Omega_{\rm DE}(z) = \Omega_{\rm DE} \frac{1}{E^2(z)}
       *  \f]
       *
       ...
       *  \Omega_\Lambda + \Omega_k(1+z)^2 + \Omega_r(1+z)^4} \f]
       *
       *  @param redshift the redshift
       *
