...
/**
 *  @file Headers/w0waCDM.h
 *
 *  @brief The class w0waCDM 
 *
 *  This file defines the interface of the class w0waCDM, used for
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class w0waCDM w0waCDM.h "Headers/w0waCDM.h"
     *
     *  @brief The class w0waCDM
     *
     *  This class is used to handle objects of type <EM> w0waCDM
     *  </EM>. They are used for cosmological calculations in the flat
     *  w0-wa-cold dark matter model
     */
    class w0waCDM : public virtual w0CDM {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class w0waCDM
       */
      w0waCDM ()
	: w0CDM() { m_model = "w0waCDM"; }

      /**
       *  @brief Main Constructor of the class w0waCDM
       *
       ...
       *  e.g. Mpc/h)
       */
      w0waCDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const double w0, const double wa, const bool unit=true);

      /**
       *  @brief Constructor of the class w0waCDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      w0waCDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~w0waCDM () = default;
      ...
      { return std::make_shared<w0waCDM>(*this); }
      ...
      { return {"Omega_matter", "Omega_CDM", "Omega_baryon", "Omega_radiation", "little_h", "scalar_amp", "scalar_pivot", "sigma8", "n_spec", "tau", "w0", "wa"}; }
       ...
       *
       *  In the Chevallier-Polarski-Linder (CPL) parameterisation,
       *  \f$w(z) = w_0 + w_a\frac{z}{1+z}\f$, the integral above can
       *  be computed as follows (see e.g. Eq.(1.4) of Bassett &
       *  Hlozek 2010):
       *
       *  \f[ f_{\rm DE}(z) = (1+z)^{3(1+w_0+w_a)}
       *  \exp\left[-3w_a\frac{z}{1+z}\right] \f]
       *
