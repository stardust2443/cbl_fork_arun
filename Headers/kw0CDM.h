...
/**
 *  @file Headers/kw0CDM.h
 *
 *  @brief The class kw0CDM 
 *
 *  This file defines the interface of the class kw0CDM, used for
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class kw0CDM kw0CDM.h "Headers/kw0CDM.h"
     *
     *  @brief The class kw0CDM
     *
     *  This class is used to handle objects of type <EM> kw0CDM
     *  </EM>. They are used for cosmological calculations in the
     *  non-flat w-cold dark matter model
     */
    class kw0CDM : public virtual kLCDM, public virtual w0CDM {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class kw0CDM
       */
      kw0CDM ()
	: kLCDM(), w0CDM() { m_model = "kw0CDM"; }

      /**
       *  @brief Main Constructor of the class kw0CDM
       *
       ...
       *  e.g. Mpc/h)
       */
      kw0CDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const double Omega_DE, const double w0, const bool unit=true);

      /**
       *  @brief Constructor of the class kw0CDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      kw0CDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~kw0CDM () = default;
      ...
      { return {"Omega_matter", "Omega_CDM", "Omega_baryon", "Omega_radiation", "little_h", "scalar_amp", "scalar_pivot", "sigma8", "n_spec", "tau", "Omega_DE", "Omega_k", "w0"}; }
      ...
      { return std::make_shared<kw0CDM>(*this); }
