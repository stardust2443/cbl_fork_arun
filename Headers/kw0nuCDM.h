...
/**
 *  @file Headers/kw0nuCDM.h
 *
 *  @brief The class kw0nuCDM 
 *
 *  This file defines the interface of the class kw0nuCDM, used for
 *  cosmological calculations in the non-flat w-cold dark matter model
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class kw0nuCDM kw0nuCDM.h "Headers/kw0nuCDM.h"
     *
     *  @brief The class kw0nuCDM
     *
     *  This class is used to handle objects of type <EM> kw0nuCDM
     *  </EM>. They are used for cosmological calculations in the non-flat
     *  w-cold dark matter model with massive neutrinos
     */
    class kw0nuCDM : public virtual w0nuCDM, public virtual kLCDM {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class kw0nuCDM
       */
      kw0nuCDM ()
	: w0nuCDM(), kLCDM() { m_model = "kw0nuCDM"; }

      /**
       *  @brief Main Constructor of the class kw0nuCDM
       *
       ...
       *  e.g. Mpc/h)
       */
      kw0nuCDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const double Omega_DE, const double w0, const double Omega_neutrinos, const double massless_neutrinos, const int massive_neutrinos, const bool unit=true);

      /**
       *  @brief Constructor of the class kw0nuCDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      kw0nuCDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~kw0nuCDM () = default;
      ...
      { return std::make_shared<kw0nuCDM>(*this); }
      ...
      { return {"Omega_matter", "Omega_CDM", "Omega_baryon", "Omega_radiation", "little_h", "scalar_amp", "scalar_pivot", "sigma8", "n_spec", "tau", "w0", "Omega_neutrinos", "massless_neutrinos", "massive_neutrinos"}; }
