...
/**
 *  @file Headers/kLnuCDM.h
 *
 *  @brief The class kLnuCDM 
 *
 *  This file defines the interface of the class kLnuCDM, used for
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class kLnuCDM kLnuCDM.h "Headers/kLnuCDM.h"
     *
     *  @brief The class kLnuCDM
     *
     *  This class is used to handle objects of type <EM> kLnuCDM
     *  </EM>. They are used for cosmological calculations in the flat
     *  Lambda-cold dark matter model with massive neutrinos
     */
    class kLnuCDM : public virtual LnuCDM, public virtual kLCDM {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class kLnuCDM
       */
      kLnuCDM ()
	: LCDM(), LnuCDM(), kLCDM() { m_model = "kLnuCDM"; }

      /**
       *  @brief Main Constructor of the class kLnuCDM
       *
       ...
       *  to reionization
       *
       *  @param Omega_k \f$\Omega_k\f$: the density of curvature
       *  energy
       *
       ...
       *  e.g. Mpc/h)
       */
      kLnuCDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const double Omega_k, const double Omega_neutrinos, const double massless_neutrinos, const int massive_neutrinos, const bool unit=true);

      /**
       *  @brief Constructor of the class kLnuCDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      kLnuCDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~kLnuCDM () = default;
      ...
      { return std::make_shared<kLnuCDM>(*this); }
      ...
      { return {"Omega_matter", "Omega_CDM", "Omega_baryon", "Omega_radiation", "little_h", "sigma8", "scalar_amp", "scalar_pivot", "n_spec", "tau", "Omega_k", "Omega_neutrinos", "massless_neutrinos", "massive_neutrinos"}; }
       ...
       *  \Omega_\Lambda + \Omega_k(1+z)^2 + \Omega_r(1+z)^4}
       *  \f]
       *
       *  @param redshift the redshift
       *
