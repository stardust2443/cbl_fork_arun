 ...
 *  @file Headers/LCDM.h
 *
 *  @brief The class LCDM 
 *
 *  This file defines the interface of the class LCDM, used for
 *  cosmological calculations in the flat Lambda-cold dark matter model
 *
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class LCDM LCDM.h "Headers/LCDM.h"
     *
     *  @brief The class LCDM
     *
     *  This class is used to handle objects of type <EM> LCDM
     *  </EM>. They are used for cosmological calculations in the flat
     *  Lambda-cold dark matter model
     */
    class LCDM : public virtual Cosmology {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class LCDM
       */
      LCDM () { m_model = "LCDM"; }
      
      /**
       *  @brief Main Constructor of the class LCDM
       *
       ...
       *  e.g. Mpc/h)
       */
      LCDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const bool unit=true);

      /**
       *  @brief Constructor of the class LCDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      LCDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~LCDM () = default;
       ...
       *
       *  this method computes the inversetruncated series necessary to
       ...
       *  universe at low enough redshifts where &Omega;<SUB>r</SUB>
       *  is negligible; it does not work for non-standard dark energy
       *  or non-flat models
       */
      ...
      { return std::make_shared<LCDM>(*this); }
      ...
      { return {"Omega_matter", "Omega_CDM", "Omega_baryon", "Omega_radiation", "h", "scalar_amp", "scalar_pivot", "sigma8", "n_spec", "tau"}; }
       ...
       *  factor. Specifically, the linear growth rate in this model
       *  is computed with the following approximation (Wan and
       *  Steinhardt 1998; Linder 2005; Huterer, and Linder 2007;
       *  Ferreira and Skordis 2010):
       *
       *  \f[ f(z) = \Omega_m^\gamma(z) \f]
       *
       *  where \f$ \gamma=0,545 \f$.
       *
       *  @param redshift the redshift at which the linear growth rate
       *  is evaluated
       *
       *  @param prec precision used for the resolution of the
       *  differential equation, not used in this model where an
       *  analytic approximation is provided
       *
