...
/**
 *  @file Headers/w0nuCDM.h
 *
 *  @brief The class w0nuCDM 
 *
 *  This file defines the interface of the class w0nuCDM, used for
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class w0nuCDM w0nuCDM.h "Headers/w0nuCDM.h"
     *
     *  @brief The class w0nuCDM
     *
     *  This class is used to handle objects of type <EM> w0nuCDM
     *  </EM>. They are used for cosmological calculations in the flat
     *  w-cold dark matter model with massive neutrinos
     */
    class w0nuCDM : public virtual w0CDM, public virtual LnuCDM {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class w0nuCDM
       */
      w0nuCDM ()
	: LCDM(), w0CDM(), LnuCDM() { m_model = "w0nuCDM"; }

      /**
       *  @brief Main Constructor of the class w0nuCDM
       *
       ...
       *  e.g. Mpc/h)
       */
      w0nuCDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const double w0, const double Omega_neutrinos, const double massless_neutrinos, const int massive_neutrinos, const bool unit=true);

      /**
       *  @brief Constructor of the class w0nuCDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      w0nuCDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~w0nuCDM () = default;
      ...
      { return std::make_shared<w0nuCDM>(*this); }
