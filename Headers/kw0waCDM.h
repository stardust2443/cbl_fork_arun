...
/**
 *  @file Headers/kw0waCDM.h
 *
 *  @brief The class kw0waCDM 
 *
 *  This file defines the interface of the class kw0waCDM, used for
...
namespace cbl {
  ...
  namespace cosmology {
    ...
    /**
     *  @class kw0waCDM kw0waCDM.h "Headers/kw0waCDM.h"
     *
     *  @brief The class kw0waCDM
     *
     *  This class is used to handle objects of type <EM> kw0waCDM
     *  </EM>. They are used for cosmological calculations in the flat
     *  w0-wa-cold dark matter model
     */
    class kw0waCDM : public virtual w0waCDM, public virtual kLCDM {
    ...
    public:
      ...
      /**
       *  @brief Default constructor of the class kw0waCDM
       */
      kw0waCDM ()
	: w0waCDM(), kLCDM() { m_model = "kw0waCDM"; }

      /**
       *  @brief Main Constructor of the class kw0waCDM
       *
       ...
       *  e.g. Mpc/h)
       */
      kw0waCDM (const double Omega_matter, const double Omega_baryon, const double Omega_radiation, const double little_h, const double scalar_amp, const double scalar_pivot, const double n_spec, const double tau, const double Omega_DE, const double w0, const double wa, const bool unit=true);

      /**
       *  @brief Constructor of the class kw0waCDM that uses built-in
       ...
       *  e.g. Mpc/h)
       */
      kw0waCDM (const std::string cosmological_model, const bool unit=true);

      /**
       *  @brief Default destructor
       */
      virtual ~kw0waCDM () = default;
      ...
      { return std::make_shared<kw0waCDM>(*this); }
      ...
      { return {"Omega_matter", "Omega_CDM", "Omega_baryon", "Omega_radiation", "little_h", "scalar_amp", "scalar_pivot", "sigma8", "n_spec", "tau", "Omega_DE", "Omega_k", "w0", "wa"}; }
